...
export default defineApp(async (_req, ctx) => {
    ...
    return (<>
      ...
      {/* Google Tag Manager Cactus*/}
      <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M5LG7766" height="0" width="0" style="display:none;visibility:hidden">
        </iframe>
      </noscript>
      {/* End Google Tag Manager Cactus*/}
      ...
      {/* Google Tag Manager Maratona*/}
      <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NN4TDB4B" height="0" width="0" style="display:none;visibility:hidden">
        </iframe>
      </noscript>
      {/* End Google Tag Manager Maratona*/}
