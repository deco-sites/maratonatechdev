...
export default function MediaAndAwards({
  ...
  media = {
    ...
    cards: [
      {
        title: 'Com mais de 600 mil alunos, Maratona Tech tem seis vezes mais inscritos',
        image: 'https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9084/3e458f36-5529-4667-b9b2-8fb923ca377e',
        cta: {
          text: 'LEIA MAIS',
          href: '#'
        }
      ...
      {
        title: 'Escolas públicas e privadas podem participar de maratona de tecnologia',
        image: 'https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9084/ad8e7ab4-ff94-4740-b0b7-e1c2a2dc980a',
        cta: {
          text: 'LEIA MAIS',
          href: '#'
        }
      },
      {
        ...
        image: 'https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9084/739f367f-0c9f-4ffb-bf07-e351376151b5',
        cta: {
          text: 'LEIA MAIS',
          href: '#'
        }
    ...
    <div class="bg-slate-950 pt-20 pb-36 space-y-20 text-white px-8 lg:px-0 -mt-10 relative">
      ...
      <div class="lg:w-10/12 mx-auto">
        <h1 class="text-3xl lg:text-4xl text-center font-sora">
          {media.title}
          <span class="bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text font-extrabold">{media.titleGradient}</span>
        </h1>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-5 my-8 justify-center items-start">
          {
            awards.pins.map((pin, index) => (
              <div class={awards.pins.length - 1 == index ? "col-span-2 lg:col-span-3 text-center text-white flex flex-col justify-center items-center" : "text-center text-white flex flex-col justify-center items-center"}>
                <span class="text-purple-500 text-7xl mb-3 flex"
                  style={{
                    color: pin.color
                  }}
                >
