...
export default function WhoCanParticipate({
  desktopBackgroundImage =
    "https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9084/e6f55904-0276-4040-8f57-c3b635e10ae9",
  mobileBackgroundImage =
    "https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/9084/14fae646-3035-4432-a351-6024ac2f9faa",
    ...
    <>
      ...
      >
        <div class="lg:w-10/12 mx-auto flex justify-end skew-y-2">
          <div class="lg:w-6/12">
            <h1
              class="text-3xl font-sora font-bold text-center"
              dangerouslySetInnerHTML={{
                __html: title,
              }}
            />
              ...
              {cards.map((card) => (
                ...
                >
                  <h1
                    ...
                    class="text-2xl font-bold font-sora"
                  >
                    {card.title}
                  </h1>
